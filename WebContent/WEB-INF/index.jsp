...
<script type="text/javascript">
	...
	function students($scope, $http) {
		$http.get('http://localhost:8080/Stundets/students').success(
				function(data) {
					$scope.students = data;
				});
	...
	<div class="wrapper">
		<div id="header" ng-controller="studentsCount">
			<ul class="nav nav-pills" role="tablist">
				<li role="presentation" class="active"><a href="/Stundets">Students
		...
		<div id="middle" ng-controller="students">
			<div class="list-group">
				...
				<a onclick="" ng-repeat="student in students | filter:query "
					href="" class="list-group-item">{{student.cipher}}
					: {{student.pib}} : {{student.address}} : {{student.mark}} :
					{{student.department}} : {{student.institute}}</a>
			</div>
		</div>
